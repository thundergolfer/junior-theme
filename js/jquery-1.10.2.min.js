...
(function(e, t) {
    ...
    x.Callbacks = function(e) {
        ...
        when: function(e) {
            ...
            if (r > 1) for (s = Array(r), l = Array(r), u = Array(r); r > t; t++) n[t] && x.isFunction(n[t].promise) ? n[t].promise()
                .done(a(t, u, n))
                .fail(o.reject)
                .progress(a(t, l, s)) : --i;
    ...
    x.fn.extend({
        ...
        addClass: function(e) {
            ...
            if (l) for (t = (e || "")
                .match(T) || []; s > a; a++) if (n = this[a], r = 1 === n.nodeType && (n.className ? (" " + n.className + " ")
                .replace(U, " ") : " ")) {
                o = 0;
    ...
    x.event = {
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (m && (c = m.events)) {
                t = (t || "")
                    .match(T) || [""], u = t.length;
                while (u--) if (s = rt.exec(t[u]) || [], d = g = s[1], h = (s[2] || "")
                    .split(".")
                    .sort(), d) {
    ...
    function Hn(e) {
        return function(t, n) {
            ...
            var r, i = 0,
                o = t.toLowerCase()
                    .match(T) || [];
            if (x.isFunction(n)) while (r = o[i++]) "+" === r[0] ? (r = r.slice(1) || "*", (e[r] = e[r] || [])
                .unshift(n)) : (e[r] = e[r] || [])
                .push(n)
        }
    }
